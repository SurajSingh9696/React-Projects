...
// If you don't have a logo image, you can use a placeholder URL:
// const logoImage = 'https://via.placeholder.com/48x48/2563eb/ffffff?text=AI';
      ...
      >
        <div className="header-content">
          <div className="logo-section">
            ...
            >
              <img src={logoImage} alt="Imagination.Ai" className="logo-image" />
            </motion.div>
